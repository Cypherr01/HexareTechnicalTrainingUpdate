...
export class AdminJwtClientService {
  ...
  baseURL: string = 'http://localhost:8189/api/v1/admins/';
  apibusUrl:string='http://localhost:8189/api/v1/buses/';
  apiUserUrl:string='http://localhost:8189/api/v1/usercustomers/';
  apiOperatorUrl:string='http://localhost:8189/api/v1/busoperators/';
