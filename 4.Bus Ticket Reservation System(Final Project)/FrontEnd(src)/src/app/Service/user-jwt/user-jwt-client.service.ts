...
export class UserJwtClientService {
  ...
  apiUrl: string = 'http://localhost:8189/api/v1/usercustomers/';
  apibUrl: string = 'http://localhost:8189/api/v1/bookings/';
  singleurl:string='http://localhost:8189/api/v1/allsinglelogin/'
